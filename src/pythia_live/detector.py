...
class Signal:
    market_id: str
    timestamp: datetime
    signal_type: str  # PROBABILITY_SPIKE, VOLUME_ANOMALY, ARBITRAGE, CORRELATION_DEV
...
class SignalDetector:
    ...
    4. Correlation deviations (related markets diverging)
    """
    ...
    def detect_all(self, market_data: Dict, price_history: pd.DataFrame) -> List[Signal]:
        """
