...
DOMAIN_FETCHERS: Dict[str, List[Callable]] = {
    ...
    "narrative_sentiment": [_fetch_social_evidence],
    "informed_flow":    [_fetch_orderbook_evidence, _fetch_equities_evidence, _fetch_crypto_evidence],
    "cross_market":     [_fetch_equities_evidence, _fetch_fixed_income_evidence, _fetch_crypto_evidence],
